...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=71,numReposBlks=71,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=39,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (SIGNAL_I_0,
    clk_0);
  ...
  design_1_NOT1_0_0 NOT1_0
       (.in(Condition_Check_0_cond_out),
        .out(NOT1_0_out));
  design_1_NOT1_0_1 NOT1_1
       (.in(xlslice_4_Dout),
        .out(NOT1_1_out));
  design_1_NOT1_2_0 NOT1_2
       (.in(HazardUnit_0_hazard),
        .out(NOT1_2_out));
  ...
  design_1_Register13_0_0 Register13_0
       (.clk(clk_0_1),
        ...
        .in(xlconcat_1_dout),
        .out(Register13_0_out),
        .rst(SIGNAL_I_0_1));
  design_1_Register1_0_0 Register1_0
       (.clk(clk_0_1),
        .en(xlconstant_2_dout),
        .flush(xlslice_18_Dout),
        .in(Status_Register_0_c),
        .out(Register1_0_out),
        .rst(SIGNAL_I_0_1));
  ...
  design_1_Val2Genrate_0_0 Val2Genrate_0
       (.MEM_EN(OR1_2_out),
        ...
        .Val_Rm(Register_6_out),
        .out(Val2Genrate_0_out));
  ...
  design_1_ila_0_0 ila_0
       (.clk(clk_0_1),
        .probe0(IF_0_PC),
        .probe1(Register_0_out),
        .probe2(Register_1_out),
        .probe3(ALU_0_result),
        .probe4(Register_2_out),
        .probe5(SIGNAL_I_0_1));
  design_1_sign_extend_0_0 sign_extend_0
       (.in(Register24_0_out),
        .out(sign_extend_0_out));
