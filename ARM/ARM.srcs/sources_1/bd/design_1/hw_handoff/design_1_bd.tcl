...
# module references:
# ADDER, ALU, Condition_Check, ControlUnit, HazardUnit, IF, MUX4, MUX9, MUX, NOT1, NOT1, NOT1, OR1, OR1, OR1, Register13, Register1, Register1, Register1, Register24, Register3, Register4, Register4, Register4, Register9, RegisterFile, Register, Register, Register, Register, Register, Register, Register, Register, Register, Status_Register, Val2Genrate, debouncer, sign_extend
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ALU_0_result [get_bd_pins ALU_0/result] [get_bd_pins Register_2/in] [get_bd_pins ila_0/probe3]
  connect_bd_net -net ALU_0_zcnv [get_bd_pins ALU_0/zcnv] [get_bd_pins Status_Register_0/zcnv]
  connect_bd_net -net Condition_Check_0_cond_out [get_bd_pins Condition_Check_0/cond_out] [get_bd_pins NOT1_0/in]
  ...
  connect_bd_net -net HazardUnit_0_hazard [get_bd_pins HazardUnit_0/hazard] [get_bd_pins IF_0/Freeze] [get_bd_pins NOT1_2/in] [get_bd_pins OR1_1/in1]
  connect_bd_net -net IF_0_PC [get_bd_pins IF_0/PC] [get_bd_pins Register_0/in] [get_bd_pins ila_0/probe0]
  connect_bd_net -net IF_0_PC_ADDR [get_bd_pins IF_0/PC_ADDR] [get_bd_pins dist_mem_gen_0/a]
  connect_bd_net -net MUX4_0_out [get_bd_pins HazardUnit_0/Src1] [get_bd_pins MUX4_0/out] [get_bd_pins RegisterFile_0/src2]
  connect_bd_net -net MUX9_0_out [get_bd_pins MUX9_0/out] [get_bd_pins Register9_0/in]
  connect_bd_net -net MUX_0_out [get_bd_pins MUX_0/out] [get_bd_pins RegisterFile_0/Result_WB]
  connect_bd_net -net NOT1_0_out [get_bd_pins NOT1_0/out] [get_bd_pins OR1_1/in2]
  connect_bd_net -net NOT1_1_out [get_bd_pins NOT1_1/out] [get_bd_pins OR1_0/in2]
  connect_bd_net -net NOT1_2_out [get_bd_pins NOT1_2/out] [get_bd_pins Register_0/en] [get_bd_pins Register_4/en]
  connect_bd_net -net OR1_0_out [get_bd_pins HazardUnit_0/Two_Src] [get_bd_pins OR1_0/out]
  connect_bd_net -net OR1_1_out [get_bd_pins MUX9_0/sel] [get_bd_pins OR1_1/out]
  connect_bd_net -net OR1_2_out [get_bd_pins OR1_2/out] [get_bd_pins Val2Genrate_0/MEM_EN]
  connect_bd_net -net Register13_0_out [get_bd_pins Register13_0/out] [get_bd_pins Val2Genrate_0/Shift_operand_I]
  connect_bd_net -net Register1_0_out [get_bd_pins ALU_0/C] [get_bd_pins Register1_0/out]
  connect_bd_net -net Register1_1_out [get_bd_pins Register1_1/out] [get_bd_pins RegisterFile_0/writebackEn]
  connect_bd_net -net Register1_2_out [get_bd_pins MUX_0/sel] [get_bd_pins Register1_2/out]
  connect_bd_net -net Register24_0_out [get_bd_pins Register24_0/out] [get_bd_pins sign_extend_0/in]
  connect_bd_net -net Register3_0_out [get_bd_pins Register3_0/out] [get_bd_pins xlslice_20/Din] [get_bd_pins xlslice_21/Din] [get_bd_pins xlslice_22/Din]
  connect_bd_net -net Register4_0_out [get_bd_pins HazardUnit_0/EXE_DEST] [get_bd_pins Register4_0/out] [get_bd_pins Register4_1/in]
  connect_bd_net -net Register4_1_out [get_bd_pins HazardUnit_0/MEM_DEST] [get_bd_pins Register4_1/out] [get_bd_pins Register4_2/in]
  connect_bd_net -net Register4_2_out [get_bd_pins Register4_2/out] [get_bd_pins RegisterFile_0/Dest_wb]
  connect_bd_net -net Register9_0_out [get_bd_pins Register9_0/out] [get_bd_pins xlslice_14/Din] [get_bd_pins xlslice_15/Din] [get_bd_pins xlslice_16/Din] [get_bd_pins xlslice_17/Din] [get_bd_pins xlslice_18/Din] [get_bd_pins xlslice_19/Din]
  connect_bd_net -net RegisterFile_0_reg1 [get_bd_pins RegisterFile_0/reg1] [get_bd_pins Register_5/in]
  connect_bd_net -net RegisterFile_0_reg2 [get_bd_pins RegisterFile_0/reg2] [get_bd_pins Register_6/in]
  connect_bd_net -net Register_0_out [get_bd_pins Register_0/out] [get_bd_pins Register_1/in] [get_bd_pins ila_0/probe1]
  connect_bd_net -net Register_1_out [get_bd_pins ADDER_0/in_0] [get_bd_pins Register_1/out] [get_bd_pins ila_0/probe2]
  connect_bd_net -net Register_2_out [get_bd_pins Register_2/out] [get_bd_pins Register_3/in] [get_bd_pins ila_0/probe4] [get_bd_pins xlslice_23/Din]
  connect_bd_net -net Register_3_out [get_bd_pins MUX_0/in_0] [get_bd_pins Register_3/out]
  connect_bd_net -net Register_4_out [get_bd_pins Register_4/out] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_10/Din] [get_bd_pins xlslice_12/Din] [get_bd_pins xlslice_13/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_6/Din] [get_bd_pins xlslice_7/Din] [get_bd_pins xlslice_8/Din] [get_bd_pins xlslice_9/Din]
  connect_bd_net -net Register_5_out [get_bd_pins ALU_0/in1] [get_bd_pins Register_5/out]
  connect_bd_net -net Register_6_out [get_bd_pins Register_6/out] [get_bd_pins Register_7/in] [get_bd_pins Val2Genrate_0/Val_Rm]
  connect_bd_net -net Register_7_out [get_bd_pins Register_7/out] [get_bd_pins dist_mem_gen_1/d]
  connect_bd_net -net Register_8_out [get_bd_pins MUX_0/in_1] [get_bd_pins Register_8/out]
  connect_bd_net -net SIGNAL_I_0_1 [get_bd_ports SIGNAL_I_0] [get_bd_pins IF_0/rst] [get_bd_pins Register13_0/rst] [get_bd_pins Register1_0/rst] [get_bd_pins Register1_1/rst] [get_bd_pins Register1_2/rst] [get_bd_pins Register24_0/rst] [get_bd_pins Register3_0/rst] [get_bd_pins Register4_0/rst] [get_bd_pins Register4_1/rst] [get_bd_pins Register4_2/rst] [get_bd_pins Register9_0/rst] [get_bd_pins RegisterFile_0/rst] [get_bd_pins Register_0/rst] [get_bd_pins Register_1/rst] [get_bd_pins Register_2/rst] [get_bd_pins Register_3/rst] [get_bd_pins Register_4/rst] [get_bd_pins Register_5/rst] [get_bd_pins Register_6/rst] [get_bd_pins Register_7/rst] [get_bd_pins Register_8/rst] [get_bd_pins Status_Register_0/rst] [get_bd_pins debouncer_0/SIGNAL_I] [get_bd_pins ila_0/probe5]
  connect_bd_net -net Status_Register_0__zcnv [get_bd_pins Condition_Check_0/ZCNV] [get_bd_pins Status_Register_0/_zcnv]
  connect_bd_net -net Status_Register_0_c [get_bd_pins Register1_0/in] [get_bd_pins Status_Register_0/c]
  connect_bd_net -net Val2Genrate_0_out [get_bd_pins ALU_0/in2] [get_bd_pins Val2Genrate_0/out]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins IF_0/clk] [get_bd_pins Register13_0/clk] [get_bd_pins Register1_0/clk] [get_bd_pins Register1_1/clk] [get_bd_pins Register1_2/clk] [get_bd_pins Register24_0/clk] [get_bd_pins Register3_0/clk] [get_bd_pins Register4_0/clk] [get_bd_pins Register4_1/clk] [get_bd_pins Register4_2/clk] [get_bd_pins Register9_0/clk] [get_bd_pins RegisterFile_0/clk] [get_bd_pins Register_0/clk] [get_bd_pins Register_1/clk] [get_bd_pins Register_2/clk] [get_bd_pins Register_3/clk] [get_bd_pins Register_4/clk] [get_bd_pins Register_5/clk] [get_bd_pins Register_6/clk] [get_bd_pins Register_7/clk] [get_bd_pins Register_8/clk] [get_bd_pins Status_Register_0/clk] [get_bd_pins debouncer_0/CLK_I] [get_bd_pins dist_mem_gen_1/clk] [get_bd_pins ila_0/clk]
  connect_bd_net -net dist_mem_gen_0_spo [get_bd_pins Register_4/in] [get_bd_pins dist_mem_gen_0/spo]
  connect_bd_net -net dist_mem_gen_1_spo [get_bd_pins Register_8/in] [get_bd_pins dist_mem_gen_1/spo]
  connect_bd_net -net sign_extend_0_out [get_bd_pins ADDER_0/in_1] [get_bd_pins sign_extend_0/out]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins MUX9_0/in_0] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins Register13_0/in] [get_bd_pins xlconcat_1/dout]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins HazardUnit_0/Rn] [get_bd_pins RegisterFile_0/src1] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_10_Dout [get_bd_pins xlconcat_1/In1] [get_bd_pins xlslice_10/Dout]
  connect_bd_net -net xlslice_12_Dout [get_bd_pins Register24_0/in] [get_bd_pins xlslice_12/Dout]
  connect_bd_net -net xlslice_13_Dout [get_bd_pins Register4_0/in] [get_bd_pins xlslice_13/Dout]
  connect_bd_net -net xlslice_14_Dout [get_bd_pins OR1_2/in1] [get_bd_pins xlslice_14/Dout]
  ...
  connect_bd_net -net xlslice_19_Dout [get_bd_pins Register3_0/in] [get_bd_pins xlslice_19/Dout] [get_bd_pins xlslice_5/Din]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins MUX4_0/in_0] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_20_Dout [get_bd_pins Register1_2/in] [get_bd_pins xlslice_20/Dout]
  connect_bd_net -net xlslice_21_Dout [get_bd_pins dist_mem_gen_1/we] [get_bd_pins xlslice_21/Dout]
  connect_bd_net -net xlslice_22_Dout [get_bd_pins HazardUnit_0/MEM_WB_EN] [get_bd_pins Register1_1/in] [get_bd_pins xlslice_22/Dout]
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins NOT1_1/in] [get_bd_pins xlslice_4/Dout]
